package com.felippe.nearby.ui.component.category
...
import com.felippe.nearby.ui.data.model.NearbyCategory
...
fun NearbyCategoryFilterChipList(
    ...
    var selectedCategoryId by remember { mutableStateOf<String?>(categories.firstOrNull()?.id.orEmpty()) }
